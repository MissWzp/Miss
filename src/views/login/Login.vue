        ...
        <van-tabs v-model="active"
          ...
          <van-tab :title="$t('login.title')">
            ...
            <van-button type="info"
                       ...
                       <van-divider><div class="switchLogin"
                 @click="switchLogin">{{this.isShowSMSLogin?$t('login.phoneVerify'):$t('login.smsMessage')}}</div></van-divider>      
          </van-tab>
          <!-- 注册 -->
...
// 引入API调用接口
import { getPhoneCaptcha, phoneCaptchaLogin, pwdLogin } from '../../server/api/index.js'
// 引入vuex
